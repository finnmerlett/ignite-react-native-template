...
import { tws } from "../../theme/tailwind"
...
const NO_COLOR_CONTENT = { ...CONTENT }
delete NO_COLOR_CONTENT.color
  ...
  return (
    <View testID="WelcomeScreen" style={FULL}>
      ...
      <Screen style={CONTAINER} preset="scroll" backgroundColor={color.transparent}>
        ...
        <Text style={CONTENT}>
          For everyone else, this is where you'll see a live preview of your fully
          functioning app using Ignite.
        </Text>
      </Screen>
